 ...
 * - fixed bug in GBufferedImage.Fill back-end call (missing ", " token)
...
void Platform::gbufferedimage_Fill(GObject* gobj, double x, double y, double width, double height, int rgb) {
    std::ostringstream os;
    os << "GBufferedImage.Fill(\"" << gobj << "\", " << (int) x << ", "
